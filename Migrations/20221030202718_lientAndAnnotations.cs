...
{
    public partial class lientAndAnnotations : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 1, new DateTime(2022, 10, 30, 16, 27, 17, 937, DateTimeKind.Local).AddTicks(7849), 1 });

            migrationBuilder.InsertData(
                table: "ClientServices",
                columns: new[] { "ID", "ClientID", "Date", "ServicesID" },
                values: new object[] { 3, 1, new DateTime(2022, 10, 30, 16, 27, 17, 939, DateTimeKind.Local).AddTicks(2008), 5 });

            migrationBuilder.InsertData(
                table: "ClientServices",
                columns: new[] { "ID", "ClientID", "Date", "ServicesID" },
                values: new object[] { 2, 2, new DateTime(2022, 10, 30, 16, 27, 17, 939, DateTimeKind.Local).AddTicks(1969), 7 });
